...
function usage()
{
    echo "centos for buidling and serving the mkdocs project using Docker "
    echo ""
    echo "./centos.sh"
    echo -e "-h --help"
    ...
    case $PARAM in
        ...
        --produce)
            ...
            if [ ! -d "$VALUE" ]; then
                ...
                echo -e '=================================================================='
                echo -e 'docker run -v $PWD:/var/centos centos produce <directoryName>'
                echo -e 'docker run -v $PWD:/var/centos centos produce my-project'
                echo -e '=================================================================='
                exit 1
            fi
            ...
            cd ..
            echo "Centos Directory is Valid Producting site.tar.gz file"
        ...
        --serve)
            if [ ! -f "site.tar.gz" ]; then
                ...
                echo -e '=================================================================='
                echo -e './centos.sh  --produce=my-project'
                echo -e '=================================================================='
                exit 1
            fi
            ...
            if [ -z "$CONTAINER" ]
                then
                     docker run -d -p 8000:8000 -v $PWD:/var/centos centos serve
                     CONTAINER=`docker ps | grep centos | awk -F" " '{print $1}'`
